...
var _ParticlesAnimation = __webpack_require__(12);

var _ParticlesAnimation2 = _interopRequireDefault(_ParticlesAnimation);
...
var particlesAnimation = new _ParticlesAnimation2.default();
		...
		value: function createHeaderWaypoint() {
			...
			new Waypoint({
				...
				handler: function handler(direction) {
					if (direction == "down") {
						that.siteHeader.addClass("header--bordered");
					} else {
...
var ParticlesAnimation = function ParticlesAnimation() {
  _classCallCheck(this, ParticlesAnimation);
};

exports.default = ParticlesAnimation;
